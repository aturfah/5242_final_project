...
- `base_csv/` Directory with the training/validation information for the  base model trained across the datasets over its folds
- `images` and `lr_images` contain the image output for scripts.